...
class EmbeddingMsgConverter:
    ...
    def from_context(context: Context) -> EmbeddingMsg:
        ...
        # Preserve precomputed vectors for reuse (optimization)
        if hasattr(context, '_precomputed_vector') and context._precomputed_vector:
            context_data["_precomputed_vector"] = context._precomputed_vector
        if hasattr(context, '_precomputed_sparse_vector') and context._precomputed_sparse_vector:
            context_data["_precomputed_sparse_vector"] = context._precomputed_sparse_vector
